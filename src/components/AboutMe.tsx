    ...
    <section id="about" className="w-full flex flex-col items-center pt-36 pb-12 relative">
      <div className="flex flex-col items-center gap-6 bg-galaxypurple/60 rounded-2xl p-10 shadow-lg w-full max-w-2xl border border-neonblue backdrop-blur-md animate-float">
        ...
        <div className="text-lg text-white text-center leading-relaxed">
          <span className="font-bold text-neonblue">I'm Manideep</span> — a passionate full stack developer on a mission to turn ideas into immersive web experiences.<br />
        ...
        <div className="bg-neonblue/20 border border-neonblue rounded-xl text-sm px-4 py-2 mt-1 text-white font-orbitron">{'🎓'} B.Tech CSE @ Vasavi College, Nandamuru | CGPA: 8.77</div>
      </div>
    </section>
  );
}
