...
const Index = () => {
  const handleDownloadResume = () => {
    ...
    window.open(
      "https://drive.google.com/file/d/1Zrkw6443TSnYSS1453B1tI0iE2MzfhaZ/view?usp=drive_link",
      "_blank"
    );
  };
  ...
  return (
    <div className="relative min-h-screen bg-cosmic text-white overflow-x-clip">
      ...
      <section className="relative flex flex-col items-center justify-center py-32 z-10">
        ...
        <p className="text-neonblue text-lg mb-5 font-orbitron">
          Explore my universe. Each planet, a skill. Each moon, a project.
        </p>
        ...
        <div className="w-full flex items-center justify-center gap-4 mt-6 flex-wrap">
          <button
            ...
            className="relative z-10 font-orbitron px-7 py-3 text-neonblue rounded-full border-2 border-neonblue hover:bg-neonblue hover:text-white transition-all shadow-glow"
          >
            Contact Me
          </button>
